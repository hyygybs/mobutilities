...
public class LifeHoeItem extends HoeItem implements LifeGearItem {
    public LifeHoeItem(Tier tier, int attackDamageModifier, float attackSpeedModifier, Properties properties) {
