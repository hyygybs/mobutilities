...
public class LifePickaxeItem extends PickaxeItem implements LifeGearItem {
    public LifePickaxeItem(Tier tier, int attackDamageModifier, float attackSpeedModifier, Properties properties) {
