...
public class LifeAxeItem extends AxeItem implements LifeGearItem {
    public LifeAxeItem(Tier tier, float attackDamageModifier, float attackSpeedModifier, Properties properties) {
